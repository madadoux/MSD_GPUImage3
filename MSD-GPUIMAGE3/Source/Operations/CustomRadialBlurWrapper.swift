...
import Foundation
public class CustomRadialBlurWrapper: BasicOperation {
    ...
    public init() {
        super.init(fragmentFunctionName:"CustomRadialBlurFragment", numberOfInputs:2)
    }
}
